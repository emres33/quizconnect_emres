...
class Question(models.Model):
    ...
    question_image = models.ImageField(upload_to ='media/', blank=True, null=True)
    star_number = models.IntegerField(blank=True, null= True,default=0)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    lesson = models.ForeignKey(Lesson, on_delete=models.CASCADE, blank = True, null= True, default = 1)
