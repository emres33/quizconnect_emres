...
#def display_answers(request, user_id, item_id):
    #answer = get_object_or_404(Answer, user_id=user_id, id=item_id)
    #answer = Answer.objects.filter(question_id=item_id)
    #return render(request, 'details.html', {'answer': answer})
